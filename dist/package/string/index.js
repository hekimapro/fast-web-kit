...
const toTitleCase = (str) => {
    try {
        str = (0, exports.removeExtraWhitespace)(str);
        if ((0, exports.isNotEmpty)(str)) {
            str = (0, exports.removeExtraWhitespace)(str);
