 ...
 */
export const isValid = (value) => (typeof value === 'string');
/**
 * Checks if a provided string is not empty.
 * @param str The string to check.
 */
export const isNotEmpty = (str) => isValid(str) ? (str.trim() !== "") : false;
/**
 ...
 */
export const convert = (value) => String(value);
/**
 ...
 */
export const hasAlphabeticCharsOnly = (str) => {
    try {
        if (isNotEmpty(str)) {
 ...
 */
export const hasNumericCharsOnly = (str) => {
    try {
        // Validate function parameters
        if (isNotEmpty(str)) {
 ...
 */
export function removeCase(str, caseType) {
    try {
        str = str.trim();
        let convertedStr = '';
 ...
 */
export const removeExtraWhitespace = (inputString) => {
    try {
